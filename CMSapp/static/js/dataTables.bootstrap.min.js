...
!function (t) {
    ...
    return x.extend(!0, o.defaults, {dom: "<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>><'row dt-row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>", renderer: "bootstrap"}), x.extend(o.ext.classes, {
        ...
        function u(e, a) {
            for (var t, n, r = function (e) {
                ...
                p && (n = -1 !== f.indexOf("disabled"), n = x("<li>", {class: m.sPageButton + " " + f, id: 0 === s && "string" == typeof t ? d.sTableId + "_" + t : null}).append(x("<a>", {
                    href: n ? null : "#",
